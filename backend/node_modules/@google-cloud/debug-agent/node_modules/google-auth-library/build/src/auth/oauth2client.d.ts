 ...
 */
import { GaxiosError, GaxiosOptions, GaxiosPromise, GaxiosResponse } from '@google-cloud/debug-agent/node_modules/google-auth-library/build/src/auth/node_modules/gaxios';
import { JwkCertificate } from '@google-cloud/debug-agent/node_modules/google-auth-library/build/src/crypto/crypto';
import { BodyResponseCallback } from '@google-cloud/debug-agent/node_modules/google-auth-library/build/src/transporters';
import { AuthClient } from '@google-cloud/debug-agent/node_modules/google-auth-library/build/src/auth/authclient';
import { Credentials } from '@google-cloud/debug-agent/node_modules/google-auth-library/build/src/auth/credentials';
import { LoginTicket } from '@google-cloud/debug-agent/node_modules/google-auth-library/build/src/auth/loginticket';
